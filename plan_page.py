...
class PlanPage(ttk.Frame):
    ...
    def open_services_main_popup(self):
        ...
        em_options = [
            ...
            "00000: ----------------------------------------------------------",         
            "99212: An office visit was conducted for a formal re-evaluation of the patient’s progress, encompassing a medically appropriate history, physical examination, and low-level medical decision-making to update the current treatment plan.",
            ...
            "99212: An office visit was performed to conduct a review of findings, which included a focused history and examination to discuss the clinical assessment and low-level medical decision-making regarding the patient's ongoing care and diagnostic results", 
            "99212-25: Beyond the standard CMT, a significant and separately identifiable E/M service was conducted to perform a review of findings, which included a focused history and examination to discuss the clinical assessment and low-level medical decision-making regarding the patient's ongoing care",
            "99212: An office visit was performed at the conclusion of this treatment episode to conduct a final evaluation, requiring a medically appropriate history, examination, and low-level medical decision-making to determine the patient’s maximal medical improvement and discharge status",
            "99212-25: At the conclusion of this treatment episode, a significant and separately identifiable E/M service was performed in addition to the CMT to conduct a final evaluation, requiring a medically appropriate history, examination, and low-level medical decision-making to determine the patient’s discharge status",
            "00000: ----------------------------------------------------------",         
